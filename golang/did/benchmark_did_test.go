...
func BenchmarkParse(b *testing.B) {
	var p *DID
	for n := 0; n < b.N; n++ {
		p, _ = Parse("did:ockam:amzbjdl8etgpgwoe841sfi6fc4q9yh82m6pkmkw5pteabvtzm7p6qe106ysiawmo")
	}
	parsed = p
}
...
func BenchmarkParseWithPath(b *testing.B) {
	var p *DID
	for n := 0; n < b.N; n++ {
		p, _ = Parse("did:ockam:amzbjdl8etgpgwoe841sfi6fc4q9yh82/6pkmkw5pteabvtzm7p6qe106ysiawmo")
	}
	parsed = p
}
